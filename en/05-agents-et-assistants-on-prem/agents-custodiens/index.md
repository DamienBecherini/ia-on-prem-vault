...
> [!tip] Living example
> This vault itself is partly maintained by a custodian agent. The `.agents/` folder contains scripts, prompts, and execution logs that orchestrate that maintenance.
...
| [[05-agents-et-assistants-on-prem/agents-custodiens/solutions/litellm|LiteLLM]] / [[00-lexique/litellm|lexicon]] | Unified proxy (Ollama, vLLM, cloud) | ✅ if local-only |
