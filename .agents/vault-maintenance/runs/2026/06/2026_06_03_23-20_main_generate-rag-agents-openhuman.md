...
## Files Changed
- Création : `03-stack-logicielle/rag-and-agents.md`
...
- L'architecture canonique "OpenHuman" (Memory Trees / SQLite + Markdown) issue de la base de connaissances interne du Vault (`01-fondations/kv-cache-and-context.md`).
