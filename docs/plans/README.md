...
Agent and maintainer plans for [`ia-on-prem-vault`](../../). Written in English. Excluded from the public site via `publish.exclude: ["docs/plans/**"]` in `site.config.json`.
...
Build, deploy, backlinks, and lexicon tooling are planned in [`starlight-obsidian-engine`](https://github.com/DamienBecherini/starlight-obsidian-engine/tree/main/docs/plans).
